 ...
 */
export async function resolverUsuario(usuarioParam) {
    if (usuarioParam)
        return idPositivo.parse(usuarioParam);
    ...
    if (!so)
        throw new Error("No hay ningún usuario con rol Seguridad Operativa");
