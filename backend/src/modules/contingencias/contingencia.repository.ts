...
const SCHEMA_BOOTSTRAP = [
  ...
  `CREATE UNIQUE INDEX IF NOT EXISTS "contingencia_catalogos_codigo_key" ON "contingencia_catalogos" ("codigo")`,
  `CREATE UNIQUE INDEX IF NOT EXISTS "uq_cont_item_catalogo_valor" ON "contingencia_catalogo_items" ("id_catalogo", "valor")`,
  `CREATE UNIQUE INDEX IF NOT EXISTS "contingencia_eventos_codigo_evento_key" ON "contingencia_eventos" ("codigo_evento")`,
  `CREATE UNIQUE INDEX IF NOT EXISTS "contingencia_atenciones_id_evento_key" ON "contingencia_atenciones" ("id_evento")`,
  `CREATE UNIQUE INDEX IF NOT EXISTS "contingencia_traslados_id_evento_key" ON "contingencia_traslados" ("id_evento")`,
  `CREATE UNIQUE INDEX IF NOT EXISTS "contingencia_personas_id_evento_key" ON "contingencia_personas" ("id_evento")`,
  `CREATE UNIQUE INDEX IF NOT EXISTS "contingencia_diagnosticos_id_evento_key" ON "contingencia_diagnosticos" ("id_evento")`,
  `CREATE UNIQUE INDEX IF NOT EXISTS "contingencia_cierres_id_evento_key" ON "contingencia_cierres" ("id_evento")`,
];
