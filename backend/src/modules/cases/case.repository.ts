...
export class CaseRepository {
   ...
   */
  static async findPlansByArea(id_area?: number) {
  ...
  static async reopenCase(id_caso: number, motivo?: string | null) {
  ...
  static async addEvidence(id_caso: number, archivos: UploadedFile[]) {
